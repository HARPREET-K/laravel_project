...
<table width="100%" border="0" cellspacing="0" cellpadding="20" bgcolor="#EEE">
  ...
  <tr>
    <td align="center" valign="middle" bgcolor="#FFFFFF" style="border-radius: 3px;"><table width="100%" border="0" cellspacing="0" cellpadding="10" style="color:#333333;">
      ...
      <tr>
        <td align="center">Please click the button below to reset your password.</td>
      </tr>
      <tr>
        <td height="50" align="center"><a href="{{ $link = secure_url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}" style="clear:both; background-color:#32466f; color:#FFF; text-decoration:none; padding:10px 30px; border-radius: 3px;">Reset Password</a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
