        ...
        <div class="modal-content">
            <div class="genInfoFormSec">
                <div class="upLoadImgSec">
                    ...
                    <form enctype="multipart/form-data" id="upload_image" role="form" method="POST" action="" >
                        <input type="hidden" name="_token" value="{{ csrf_token()}}">   
                        ...
                        <div class="file-field input-field upProfBtnRow" id="imageData">
                            <div class="btn upProfImgBtn">
                              <!--<span>Upload Profile Image</span>-->
                                ...
                                <input type="file" name="images"   accept='image/*' id="fileupload" onchange="preview_image();">
                            </div>
