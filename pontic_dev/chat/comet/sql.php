...
$sql_queries['clearGuestEntries'] = "delete from cometchat_guests where id in (select userid from cometchat_status where cometchat_status.lastactivity<{time}-10800)";
